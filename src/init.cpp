    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Litecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  goldbuckd [options]                     " + "\n" +
                  "  goldbuckd [options] <command> [params]  " + _("Send command to -server or goldbuckd") + "\n" +
                  "  goldbuckd [options] help                " + _("List commands") + "\n" +
                  "  goldbuckd [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: goldbuckd.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 49877 or testnet: 149877)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 49876 or testnet: 149876)") + "\n" +
